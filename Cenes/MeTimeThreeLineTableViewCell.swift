//
//  MeTimeThreeLineTableViewCell.swift
//  Deploy
//
...
class MeTimeThreeLineTableViewCell: UITableViewCell {
...
extension MeTimeThreeLineTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource {
