...
//  Deploy
//
//  Created by Cenes_Dev on 16/10/2019.
...
extension EventMO {
    ...
    @NSManaged public func addToEventMembers(_ value: EventMemberMO)

    @objc(removeEventMembersObject:)
    @NSManaged public func removeFromEventMembers(_ value: EventMemberMO)
